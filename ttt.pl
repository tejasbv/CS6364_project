...
%% Designed to play against a human (Java GUI)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% The empty Tic Tac Toe board
%%    Z1 Z2 Z3
...
%% e.g., win([P,P,P|_],P).  is NOT correct because it could bind 
%%%%%
...
% Computer (o) searches for the best tic tac toe move, 
% Human player is x.
...
:- assert(spy).    % Comment out to stop the spy.
